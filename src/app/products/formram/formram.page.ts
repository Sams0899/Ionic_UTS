...
@Component({
  selector: 'app-formram',
  templateUrl: './formram.page.html',
  styleUrls: ['./formram.page.scss'],
})
export class FormramPage implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    this.presentLoading().then(() => {
      this.presentToast();
      this.productsService.addRam(id, name, brand, model,speed,size, price, stock ,url);
