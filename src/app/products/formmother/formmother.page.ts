...
@Component({
  selector: 'app-formmother',
  templateUrl: './formmother.page.html',
  styleUrls: ['./formmother.page.scss'],
})
export class FormmotherPage implements OnInit {
  ...
  onSubmit(form: NgForm){
    ...
    this.presentLoading().then(() => {
      this.presentToast();
      this.productsService.addMother(id, name, brand,chipset,procsfor, model, price, stock ,url);
